                ...
                <form method="post" id="tes"  action="add-proses.php" class="form-horizontal">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group">
                            <label for="jenis_brg" class=" col-sm-3 control-label">Teknisi</label>
                            <div class="col-sm-5">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <table class="table table-responsive">
                        ...
                        <?php 
                            $sekarang  = date("Y-m-d");
                            $queryTampil = mysqli_query($koneksi, "SELECT sementara.id_user, sementara.nik, sementara.id_sementara, stokbarang.nama_brg, teknisi.nik,teknisi.nama,stokbarang.satuan, jumlah FROM sementara INNER JOIN stokbarang ON sementara.kode_brg = stokbarang.kode_brg INNER JOIN teknisi ON sementara.nik = teknisi.nik WHERE tgl_permintaan = '$sekarang' AND sementara.id_user='$_SESSION[id_user]' "  );
                            $no = 1;
